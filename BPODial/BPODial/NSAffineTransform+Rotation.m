...
CGFloat vecLength				(CGPoint a)					{ return sqrtf(vecSquareLength(a));	}
CGFloat vecSquareLength		(const CGPoint a)			{	return vecDotProduct(a, a);	}
CGPoint vecMultiply			(CGPoint a, CGFloat s)	{ return CGPointMake(a.x * s, a.y * s);	}
CGPoint vecAdd					(CGPoint a , CGPoint b)	{ return CGPointMake(a.x + b.x, a.y + b.y);	}
CGPoint vecSub					(CGPoint a , CGPoint b)	{ return CGPointMake(a.x - b.x, a.y - b.y);	}
CGPoint vecNormalize			(CGPoint a)					{ return vecMultiply(a, 1.0f / vecLength(a));	}
CGFloat vecDotProduct		(CGPoint a, CGPoint b)	{ return a.x * b.x + a.y * b.y;	}
